...
int main() {
    ...
    vector<string> additionalItems;  // Moved this line outside the if block
    ...
    // Apply discounts based on the number of additional items purchased
    ...
    // Calculate discount and new total price
    ...
    // Display amount saved and new total price after discount
    cout << fixed << setprecision(2);
    cout << "\nAmount of Money Saved: $" << discountAmount << endl;
    cout << "New Total Price (after discount): $" << discountedPrice << endl;
